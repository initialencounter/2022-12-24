export interface NonoCareerResponse {
  code: number;
  data: Data;
  msg: null;
  url: null;
...
export interface ProTimeRank {
  ...
  timePro: number;
  uid: string;
  user: ProTimeRankUser;
  win: number;
}

export interface ProTimeRankRecord {
  bvs: number;
  column: number;
  createTime: null;
  finished: boolean;
...
export interface ProTimeRankUser {
  avatar: string;
  background: string;
  chaosInGame: boolean;
  chaosInView: boolean;
