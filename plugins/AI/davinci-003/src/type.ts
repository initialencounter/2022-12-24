    ...
    Schema.union([
      Schema.object({
        ...
        baseURL: Schema.union([
          ...
          Schema.const('https://maas-api.cn-huabei-1.xf-yun.com').description('（讯飞）https://maas-api.cn-huabei-1.xf-yun.com'),
    ...
    Schema.union([
      Schema.object({
        ...
        appointModel: Schema.union([
          ...
          Schema.const('xdeepseekr1').description('xdeepseekr1（讯飞 deepseekr1）'),
          Schema.transform(String, value => value),
