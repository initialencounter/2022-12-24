...
exports.Cube = exports.rot90 = exports.rot = void 0;
const log = console.log;
const rot = (arr, derect) => {
    const res = [];
...
exports.rot = rot;
const rot90 = (arr, time = 1) => {
    let resp = [];
    if (time < 0) {
        let temp = arr;
        for (var i = time; i < 0; i++) {
            const res = (0, exports.rot)(temp, false);
            temp = res;
        }
        resp = temp;
    }
        ...
        for (var i = 0; i < time; i++) {
            const res = (0, exports.rot)(temp, true);
            temp = res;
        }
        resp = temp;
    }
...
class Cube {
    ...
    F() {
        this.face = (0, exports.rot90)(this.face, -1);
        this.left = (0, exports.rot90)(this.left);
        this.up = (0, exports.rot90)(this.up, 2);
        this.right = (0, exports.rot90)(this.right, -1);
        const temp1 = [];
        ...
        this.up[0] = temp1;
        this.down[0] = temp2;
        this.left = (0, exports.rot90)(this.left, -1);
        this.up = (0, exports.rot90)(this.up, 2);
        this.right = (0, exports.rot90)(this.right);
    }
    F_() {
        this.face = (0, exports.rot90)(this.face);
        this.left = (0, exports.rot90)(this.left);
        this.up = (0, exports.rot90)(this.up, 2);
        this.right = (0, exports.rot90)(this.right, -1);
        const temp1 = [];
    ...
    B() {
        this.back = (0, exports.rot90)(this.back, -1);
        this.left = (0, exports.rot90)(this.left, -1);
        this.down = (0, exports.rot90)(this.down, 2);
        this.right = (0, exports.rot90)(this.right);
        const temp1 = [];
        for (var colo of this.left[0]) {
            temp1.push(colo);
    ...
    B_() {
        this.back = (0, exports.rot90)(this.back);
        this.left = (0, exports.rot90)(this.left, -1);
        this.down = (0, exports.rot90)(this.down, 2);
        this.right = (0, exports.rot90)(this.right);
        const temp1 = [];
    ...
    L() {
        this.left = (0, exports.rot90)(this.left, -1);
        this.back = (0, exports.rot90)(this.back);
        this.up = (0, exports.rot90)(this.up, -1);
        this.face = (0, exports.rot90)(this.face, -1);
        this.down = (0, exports.rot90)(this.down, -1);
        const temp1 = [];
        ...
        this.down[0] = temp2;
        this.back = (0, exports.rot90)(this.back, -1);
        this.up = (0, exports.rot90)(this.up);
        this.face = (0, exports.rot90)(this.face);
        this.down = (0, exports.rot90)(this.down);
    }
    L_() {
        this.left = (0, exports.rot90)(this.left);
        this.back = (0, exports.rot90)(this.back);
    ...
    D() {
        this.down = (0, exports.rot90)(this.down, -1);
        this.left = (0, exports.rot90)(this.left, 2);
        this.right = (0, exports.rot90)(this.right, 2);
        this.face = (0, exports.rot90)(this.face, 2);
        this.back = (0, exports.rot90)(this.back, 2);
        const temp1 = [];
        for (var colo of this.left[0]) {
            temp1.push(colo);
        }
